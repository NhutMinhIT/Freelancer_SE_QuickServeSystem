                        ...
                        <div className="w-1/4 p-4">
                            <div className="flex items-center mb-4">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-500 mt-3">Được phép JPG, GIF, PNG. Kích thước tối đa 800K</p>
                                </div>
                            </div>
                            <div className="mt-4 text-left">
                                <button className="bg-blue-500 text-white py-2 px-4 rounded-md font-bold mr-4">Lưu thay đổi</button>
                                <button className="bg-gray-500 text-white py-2 px-4 rounded-md font-bold">Hủy bỏ</button>
                            </div>
                        </div>
