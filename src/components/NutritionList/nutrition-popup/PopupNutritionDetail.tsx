                        ...
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full pb-2">
                                ...
                                <div className="mt-4 border-t grid grid-cols-2 gap-4 p-8">
                                    ...
                                    <div>
                                        <img
                                            src={`${nutri?.imageUrl}?t=${new Date().getTime()}`}
                                            alt="Simple image"
                                    ...
                                    <div>
                                        <span>
                                            {typeof nutri?.created === 'string'
                                                ? new Date(
                                                    nutri.created,
                                                ).toLocaleDateString('vi-VN')
                                                : nutri?.created.toLocaleDateString(
                                                    'vi-VN',
                                                )}
                                        </span>
                                    </div>
                                        ...
                                        <span>
                                            {nutri?.lastModified &&
                                                ...
                                                ? typeof nutri.lastModified ===
                                                    ...
                                                    : nutri?.lastModified.toLocaleDateString(
                                                        'vi-VN',
                                                    )
                                                : 'Chưa có thay đổi'}
                                        </span>
...
export default PopupNutritionDetail
