...
import { FilterPaymentsConfig, getPaymentsStore, setFilterPaymentsStoreConfig } from "../../../services/features/paymentSlice";
...
const PaymentStoreComponent = () => {
  ...
  const handleFilterChange = (updates: Partial<FilterPaymentsConfig>) => {
